    ...
    var MapMarker = /** @class */ (function () {
        ...
        MapMarker.prototype._combineOptions = function () {
            ...
            return rxjs.combineLatest([this._options, this._title, this._position, this._label, this._clickable])
                ...
                var combinedOptions = tslib.__assign(tslib.__assign({}, options), { title: title || options.title, position: position || options.position, label: label || options.label, clickable: clickable !== undefined ? clickable : options.clickable, map: _this.googleMap._googleMap || null });
                return combinedOptions;
            }));
        };
